...
const jintoriPrefix = `<g fill="none" stroke="#40584b" stroke-width="38" stroke-linecap="round" stroke-linejoin="round">
  <path d="M35 54 L55 63 M31 103 L49 111 M37 157 Q100 157 113 80"/>
  <path d="M97 34 L104 45 M121 28 L129 39" stroke-width="20"/>
  <path d="M161 57 L187 76 M158 157 Q218 147 248 77" stroke="#cdb487"/>
  <path d="M296 43 V157 M297 84 Q330 92 352 112"/>
  <path d="M419 44 V99 M490 44 V95 Q490 135 452 158" transform="translate(-12 0)" stroke="#cdb487"/>
</g>`;
