...
(async()=>{
  ...
  await advance(600); assert.equal(await page.locator('#game-voice-guide').getAttribute('data-voice-word'),'つぎ'); await say('オッケー');
  ...
  assert.equal(await page.locator('#cert-voice-guide').getAttribute('data-voice-word'),'つぎ');
