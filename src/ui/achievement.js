...
export function medalMarkup(medal) {
  return `<span class="award-medal ${medal}" aria-hidden="true"><svg viewBox="0 0 48 56"><path class="ribbon" d="M10 28 7 55l13-6 4 5 4-5 13 6-3-27"/><circle cx="24" cy="22" r="20"/><circle class="medal-ring" cx="24" cy="22" r="15"/><path class="medal-star" d="m24 10 3.6 7.4 8.2 1.2-5.9 5.8 1.4 8.2L24 28.7l-7.3 3.9 1.4-8.2-5.9-5.8 8.2-1.2Z"/></svg></span>`;
}
